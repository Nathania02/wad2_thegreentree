            ...
            if(comment.postid == post_id){  
              for(var user of usersList){
                if(user.userId == comment.userid){
                  ...
                  +"<button id='like' @click='add_like("+comment.likecount+")'><img id='like_img' src='images/thumb-up.png'></button>"
            ...
            //   console.log(comments_array);
              if(comment.desc == comment_desc){
                ...
                .then(() => {
                  ...
                  document.getElementsByClassName(id_comment)[0].innerText = "Likes: " + like_number++;
                  // window.location.reload();
                }) 
                .catch((error) => {
                  console.log(error);
